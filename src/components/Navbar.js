            ...
            <div className="collapse navbar-collapse" id="navbarNavAltMarkup">
              <div className="navbar-nav">
                <Link to="product-group"
                    ...
                    smooth={false}
                    offset={-10}
                    duration={1000} className="nav-link btn btn-lg btn-outline-danger" href="#">Nos produits </Link>
                    &nbsp;
                ...
                <Link to="contact-form"
                    ...
                    smooth={false}
                    offset={-10}
                    duration={500} className="nav-link btn btn-lg btn-outline-danger" href="#">Contact </Link>
